					...
					<ul>
						...
						<li><div class="header-login">
									 <div class="top-nav-right">
										<div id="loginContainer"> <a href="#" target="_blank" id="loginButton"><span>Login</span></a>
									  </div>
								   </div>
							</div></li>
							<li><div class="header-login">
								<div class="top-nav-right">
								    <div id="loginContainer"> <a href="/RegistGuru" target="_blank" id="register"><span>Register</span></a>
									</div>
								</div>
							</div></li>
					</ul>
